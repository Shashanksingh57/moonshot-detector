...
echo ""
echo "Data Quality:"
echo "  - Validation reports saved to: data/validation_reports/"
echo "  - Review validation summary above"
echo "  - Assets with CRITICAL issues will NOT be used for training"
echo ""
echo "Next steps:"
echo "  1. Review data quality summary above"
echo "  2. Check detailed validation reports: python scripts/validate_data.py --summary"
echo "  3. Run feature engineering: bash scripts/run_feature_engineering.sh"
echo "  4. Train models: bash scripts/train_all_models.sh"
echo "=================================================="
